...
export default function RestaurantOnboardingPage() {
  ...
  useEffect(() => {
    ...
    fetchStatus();
  }, [user, onboardingStatus, checkOnboardingStatus]);

  // Also fetch when isAuthenticated changes
  useEffect(() => {
    if (isAuthenticated && user && !onboardingStatus) {
      checkOnboardingStatus();
    }
  }, [isAuthenticated, user, onboardingStatus, checkOnboardingStatus]);
  ...
  const getButtonConfig = () => {
    if (isApproved) {
      return {
        text: 'Set Up Menu Card',
        onClick: () => router.push("/partner-menu"),
